...
function build_search_where(string $code, string $area, ?string $year, string $measure, string $value, array &$params): string
{
    $where = [];
...
try {
    ...
    $stmt = $db->prepare("SELECT COUNT(*) FROM DATA_API_HOUSING WHERE $where_sql");
